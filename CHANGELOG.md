...
- Fixed a KP303 strip-child reload regression
- Fixed a related bug where previously-configured devices
...
- Each managed device kind now has its own standalone entity implementation
